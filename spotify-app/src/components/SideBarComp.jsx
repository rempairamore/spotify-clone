      ...
      <div className="col-2">
        ...
        >
          ...
          {localStorage.getItem('loggato') ? (
            <>
            <a href="#">Howdy <strong>Joe</strong></a>
            <Button variant="danger" className="logout-btn" type="button" onClick={handleLogOut}>
              Log Out
            </Button>
            </>
        ) : (
          <>
            <Button variant="primary" className="signup-btn" type="button" onClick={() => alert('Currently not accepting new sign-ups.')}>
              Sign Up
            </Button>
            <Button
              variant="success"
            ...
            <Modal show={show} onHide={handleClose}>
              ...
              <Modal.Body>
                <p>
                  email: <strong>joe@example.com</strong>{" "}
                </p>
                <p>
                  pwd: <strong>prova123</strong>
                </p>
                <Form>
            ...
            <br />
            <a href="https://github.com/rempairamore" target='_blank'><span className="copyleft">&copy;</span> Mario Petrella</a>
          </div>
        </nav>
      </div>
    </div>
